...
{
	public class Translations : Steema.TeeChart.Samples.BaseForm
	{
    ...
    private void AddLanguages()
    {
      ...
      Assembly a=Assembly.GetAssembly(typeof(Steema.TeeChart.Languages.Spanish));
      Type[] types=a.GetExportedTypes();
      foreach (Type t in types) 
        if ((t.Name!="AskLanguage") && (t.Name!="Translator"))
