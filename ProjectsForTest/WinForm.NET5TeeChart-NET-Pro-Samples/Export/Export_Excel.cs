...
{
	public class Export_Excel : Samples.BaseForm
	{
		...
		public Export_Excel()
		{
			...
			this.barSeries1.Add(3,"1st");
			this.barSeries1.Add(0,"2nd");
			this.barSeries1.Add(-3,"3rd");
			this.barSeries2.Add(2,"1st");
			this.barSeries2.Add(-2,"2nd");
			this.barSeries2.Add(3,"3rd");
		}
      ...
      saveFileDialog1.Filter="Excel files (*.xls)|*.xls";
			if (this.saveFileDialog1.ShowDialog() == DialogResult.OK)
			{
				...
				tChart1.Export.Data.Excel.Save(this.saveFileDialog1.FileName);
			}		
		}
	}
}
