...
{
	public class SeriesType_Funnel : Samples.BaseForm
	{
		...
		public SeriesType_Funnel()
		{
			...
			this.funnelSeries1.Add(50,110,"1st");
			this.funnelSeries1.Add(200,50,"2nd");
			this.funnelSeries1.Add(100,50,"3rd");
			this.funnelSeries1.Add(60,55,"4th");
		...
		{
			this.funnelSeries1.DifferenceLimit = (double)numericUpDown1.Value * 0.01;
			this.funnelSeries1.Recalc();
		}
	}
}
