...
{
	public class Series_Error : Samples.BaseForm
	{
		...
		public Series_Error()
		{
			...
			this.errorSeries1.Add(0, 50, 10, "A");
			this.errorSeries1.Add(1, 80, 20, "B");
			this.errorSeries1.Add(2, 20,  8, "C");
			this.errorSeries1.Add(3, 60, 30, "D");
			this.errorSeries1.Add(4, 40,  5, "E");
		}
