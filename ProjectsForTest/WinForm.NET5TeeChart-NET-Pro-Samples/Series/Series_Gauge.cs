...
{
	public class Series_Gauge : Steema.TeeChart.Samples.BaseForm
	{
      ...
      Steema.TeeChart.Editors.Series.GaugesSeries s = new Steema.TeeChart.Editors.Series.GaugesSeries(gauges1);
