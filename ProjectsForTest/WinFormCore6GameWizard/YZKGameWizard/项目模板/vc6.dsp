...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "depends\include" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /GZ  /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib  kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"depends\lib"
# Begin Special Build Tool
OutDir=.\Debug
ProjDir=.
SOURCE="$(InputPath)"
PreLink_Cmds=xcopy "$(ProjDir)\dlls" "$(OutDir)\" /E /Y /D	xcopy "$(ProjDir)\Images" "$(OutDir)\Images\" /E /Y /D	xcopy "$(ProjDir)\Sounds" "$(OutDir)\Sounds\" /E /Y /D	xcopy "$(ProjDir)\Sprites" "$(OutDir)\Sprites\" /E /Y /D
